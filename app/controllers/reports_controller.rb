class ReportsController < ApplicationController
	...
	def select
		if current_user.admin?
			@users = User.all.where("role = 'employee' and active = 'active'").order("Firstname ASC")
      @client = Client.all
		else
		end
